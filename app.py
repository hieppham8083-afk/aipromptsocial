...
def ensure_more_demo_posts() -> None:
    ...
    demo_posts = [
        ...
        ("arisignal", "Prompt", "AI news credibility scorecard", "Score AI announcements by source quality, reproducible evidence, customer proof, and whether builders can test it today.", "Create a credibility scorecard for this AI announcement. Rate source quality, evidence, deployment readiness, and what to verify next.", "GPT", ["ai-news", "credibility", "analysis"]),
        ("jonpromptlab", "Workflow", "Model benchmark watchlist", "Track new model benchmark claims and convert them into practical questions about cost, latency, context, and reliability.", "Turn these model benchmark posts into a watchlist with claimed win, likely caveat, test needed, and practical team impact.", "Sheets + GPT", ["ai-news", "benchmarks", "models"]),
        ("maya-builds", "Idea", "AI game NPCs should have readable limits", "Players enjoy AI characters more when the game clearly shows what they know, what they can do, and where they may be wrong.", "", "Game design", ["ai-games", "npc", "ux"]),
        ("jonpromptlab", "Prompt", "Generate five AI game fail states", "Design fail states that keep the story moving instead of ending the session after one bad answer or missed clue.", "For this AI game concept, create five fail-forward states with consequence, recovery path, and how the world remembers it.", "GPT", ["ai-games", "fail-forward", "design"]),
    ]
